...
var accountPermissions = [{
  ...
  required_auth: {
    threshold: 1,
    keys: [{
      key: 'VEX7vgT3ZsuUxWH1tWyqw6cyKqKhPjUFbonZjyrrXqDauty61SrYe',
      weight: 1
    }],
    accounts: []
  }
  ...
  required_auth: {
    threshold: 1,
    keys: [{
      key: 'VEX5MiUJEXxjJw6wUcE6yUjxpATaWetubAGUJ1nYLRSHYPpGCJ8ZU',
      weight: 1
    }],
    accounts: []
  }
  ...
  required_auth: {
    threshold: 1,
    keys: [{
      key: 'VEX8jJUMo67w6tYBhzjZqyzq5QyL7pH7jVTmv1xoakXmkkgLrfTTx',
      weight: 1
    }],
    accounts: []
  }
